...
<body>
	<div class="container-fluid">
		<div class="row rowPadding well well-sm">
			<div class="col-xs-3 col-sm-2 col-md-2 col-lg-2">
				<a href="/bro/lists" data-toggle="tooltip" data-placement="bottom" title="View Lists"><img class="img-responsive topButton" src="https://s3-us-west-2.amazonaws.com/elasticbeanstalk-us-west-2-119295481920/Images/Icons/listLogo.png"></a>
			</div>
	...
	<div class=" col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<button id="clicker" type="button" class="btn btn-circle btn-xl listButtonMarg center-block">
...
<ul style="left: 200px; top: 30px;" class="hidden">
...
<ul style="left: 200px; top: 60px;" class="hidden">
<li class="final upmenu hide"><a class="showmethemoney"><span class="glyphicon glyphicon-arrow-left"></span>Back</a></li>
<li class="final closemenu hide"><a class="showmethemoney"><span class="glyphicon glyphicon-remove"></span>Close</a></li>
...
<li class="list-item menu-item final"><a class="showmethemoney finalNode" database-id="1">Actors</a></li>
	...
	<div class="col-md-6"><div class="item-desktop" id="list1"><a href="Actors"><img class="img-responsive img-rounded imager center-block" src="https://s3-us-west-2.amazonaws.com/elasticbeanstalk-us-west-2-119295481920/Images/ListCovers/actorCover.jpg"></a><div class="showlist-desktop">Actors</div></div></div><div class="col-md-6"><div class="item-desktop" id="list0"><a href="Villains"><img class="img-responsive img-rounded imager center-block" src="https://s3-us-west-2.amazonaws.com/elasticbeanstalk-us-west-2-119295481920/Images/ListCovers/villains.jpg"></a><div class="showlist-desktop">Villains</div></div></div></div><div class="container-fluid main-body" id="spinnerbody">
