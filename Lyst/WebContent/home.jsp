...
<body>
	<div class="container-fluid">
		...
		<div class="row">
			<div id="leftPic" class=" col-xs-6 col-sm-6 col-md-5 col-lg-5 nopadding">
			...
			<div id="rightPic" class="col-xs-6 col-sm-6 col-md-5 col-lg-5 nopadding">
				<img src="${sessionScope.rightItem.picPath}"
					class="img-responsive center-block"></img>
			</div>
		</div>
		<div class="row">
			<div id="leftName" class="hidden-xs hidden-sm col-md-5 col-lg-5 centerAlign">
				<h3>
					<c:out value="${sessionScope.leftItem.name}"></c:out>
				</h3>
			</div>
			...
			<div class="hidden-xs hidden-sm col-md-2 col-lg-2"></div>
			<div id="rightName" class="hidden-xs hidden-sm col-md-5 col-lg-5 centerAlign">
				<h3>
					<c:out value="${sessionScope.rightItem.name}"></c:out>
				</h3>
			</div>
