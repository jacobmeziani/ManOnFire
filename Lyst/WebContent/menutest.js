...
function start_v_menu(i){
	...
	for(var k=function(a,b){ 
		...
		var e =b[a].parentNode; //parentdude
		c.getElementsByTagName("a")[0].className+=" arrow";
		b[a].style.left=c.offsetWidth+"px"; //important - adjusts the submenu to the positioning of the parent node of the parent node
		b[a].style.top=c.offsetTop+"px"; //same above
